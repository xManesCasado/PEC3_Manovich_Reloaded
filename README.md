...
Estos nuevos medios no deben ser confundidos con un simple caso multimedia. Que es un espacio donde los elementos conviven entre ellos sin llegar a fusionarse pero son comprendidos por nosotros cada uno por separado y sin variar su forma. El ejemplo más claro de esto es una página WEB. En ella encontramos numeross tipos de medios pero siempre de manera separada. 

Los medios híbridos en cambio, suponen el mix de varios elementos que mediante una fusión completa de sus posibilidades, dan lugar a un resultado totalmente nuevo que nosotros los humanos comprendemos en uno solo. Es comparable a la hibridación de los seres, ya que mezclando a dos "progenitores" obtenemos un resultado mejorado de ellos que sería el "hijo".
